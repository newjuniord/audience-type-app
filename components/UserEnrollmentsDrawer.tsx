...
export default function UserEnrollmentsDrawer({ isOpen, onClose, user }: UserEnrollmentsDrawerProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex justify-end bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="w-full max-w-md bg-white dark:bg-[#1a1a1a] h-full shadow-2xl overflow-y-auto animate-in slide-in-from-right duration-300 border-l border-black/5 dark:border-white/10 p-6">
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-start justify-between gap-2">
                                            ...
                                            <span className={`px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wider ${enrollment.productType.toLowerCase().includes('course')
                                        ...
                                        <div className="flex items-center gap-2 mt-1 text-xs text-black/50 dark:text-white/50">
