...
export default function VideoPlayer({ url, className = "", roundedClassName = "rounded-3xl" }: VideoPlayerProps) {
    ...
    return (
        ...
        >
            ...
            <div className="absolute top-4 right-6 z-10 pointer-events-none opacity-40 select-none flex flex-col items-end drop-shadow-lg">
                <span className="font-black text-white text-lg tracking-tighter">DJR AKADEMI</span>
                <span className="text-[9px] text-white/80 font-bold uppercase tracking-[0.3em]">Premium Player</span>
            </div>
