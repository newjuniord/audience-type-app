        ...
        <div className="max-w-2xl mx-auto space-y-8 animate-in fade-in duration-500">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <div className="bg-white border border-black/5 rounded-2xl p-6 space-y-5">
                    ...
                    <div>
                        <label className="block text-[10px] font-bold uppercase tracking-widest text-black/40 mb-2">Image du Kado</label>
                        <input 
                            type="file" 
                            hidden 
                            ref={photoInputRef} 
                        ...
                        <div className="flex items-center">
                            <input
                                ...
                                placeholder="https://..."
                                className="w-full border border-black/10 rounded-l-xl px-4 py-3 text-sm focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all border-r-0"
                            />
                            <button
                                type="button"
                                onClick={() => photoInputRef.current?.click()}
                                disabled={isUploadingPhoto}
                                className="px-6 h-[46px] bg-black/5 hover:bg-black/10 text-black rounded-r-xl border border-black/10 font-bold text-xs uppercase tracking-wider transition-all disabled:opacity-50 whitespace-nowrap"
                            >
                                {isUploadingPhoto ? "Upload..." : "Uploader"}
                            </button>
                        </div>
                        {photoLink && (
