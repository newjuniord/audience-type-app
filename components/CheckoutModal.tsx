    ...
    try {
      ...
      if (contactMethod === 'whatsapp') {
        ...
        if (genData.action === "redirect_to_whatsapp" && genData.businessPhone) {
          const cleanBizPhone = genData.businessPhone.replace(/"/g, '').replace(/'/g, '');
          setWhatsappRedirect({
              url: `https://wa.me/${cleanBizPhone}?text=${encodeURIComponent("Bonjou, mwen ta renmen resevwa kòd verifikasyon mwen an.")}`,
              businessPhone: `+${cleanBizPhone}`
          });
        } else {
          setWhatsappRedirect(null);
                ...
                <div className="text-center py-4">
                  {magicLinkToken ? (
                    ...
                    <>
                      ...
                      <h2 className="text-xl font-black mb-2 leading-tight uppercase">Ouvri WhatsApp !</h2>
                      <div className="text-xs text-white/60 mb-6 leading-relaxed max-w-sm mx-auto">
