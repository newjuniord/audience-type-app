                ...
                const promises = snap.docs.map(async (bookingDoc) => {
                    ...
                    if (d.bookingDate && d.bookingTime && validStatuses.includes((d.status || "").toLowerCase()) && d.bookingDate >= todayStr) {
                        ...
                        try {
                            ...
                            console.error("Error fetching service phone:", e);
                        }
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 16 }}>
                        ...
                        <div style={{ background: "rgba(37,211,102,0.05)", border: "1px solid rgba(37,211,102,0.15)", borderRadius: 16, padding: "14px 16px", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
                            ...
                            <div style={{ display: "flex", alignItems: "stretch", background: "rgba(37,211,102,0.1)", border: "1px solid rgba(37,211,102,0.2)", borderRadius: 8, overflow: "hidden" }}>
                                <a 
                                    href={`https://wa.me/${consultation.adminPhone?.replace(/[^0-9]/g, "") || "821012345678"}`}
                                    target="_blank" 
                                    rel="noreferrer"
                                    style={{ display: "flex", alignItems: "center", gap: 6, padding: "8px 10px", color: "#25D366", fontSize: 11, fontWeight: 800, textDecoration: "none", flex: 1 }}
                                >
                                    ...
                                    {consultation.adminPhone ? `+${consultation.adminPhone.replace(/[^0-9]/g, "")}` : "+82 10 1234 5678"}
                                </a>
                                <button
