            ...
            >
                ...
                <div className="flex-1 overflow-y-auto px-8 py-8 space-y-10 custom-scrollbar">
                    ...
                    <section className={`transition-all duration-700 delay-[400ms] ${isOpen ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
                        <label className="block text-[10px] font-black uppercase text-black/40 dark:text-white/40 tracking-widest mb-4">Video (URL ou Fichier)</label>
                        <input 
                            type="file" 
                            hidden 
                            ref={videoInputRef} 
                        ...
                        <div className="flex items-center">
                            <div className="flex items-center gap-3 px-6 py-4 rounded-l-2xl bg-black/[0.03] dark:bg-white/[0.03] flex-1">
                                <span className="material-symbols-outlined text-black/20 dark:text-white/20">link</span>
                                <input
                                    className="flex-1 bg-transparent border-none p-0 text-sm font-medium focus:ring-0"
                                    placeholder="https://vimeo.com/... ou URL directe"
                                    type="text"
                                    value={videoUrl}
                            ...
                            <button
                                ...
                                className="px-6 h-[52px] bg-primary text-white rounded-r-2xl font-bold text-xs uppercase tracking-wider transition-all disabled:opacity-50 whitespace-nowrap"
                            >
                    ...
                    <section className={`transition-all duration-700 delay-500 ${isOpen ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
                        <label className="block text-[10px] font-black uppercase text-black/40 dark:text-white/40 tracking-widest mb-4">Fichier Ressource (URL ou Fichier)</label>
                        <input 
                            type="file" 
                            hidden 
                        ...
                        <div className="flex items-center">
                            ...
                            <button
                                ...
                                className="px-6 h-[52px] bg-black/10 dark:bg-white/10 text-black dark:text-white rounded-r-2xl font-bold text-xs uppercase tracking-wider transition-all disabled:opacity-50 whitespace-nowrap hover:bg-black/20 dark:hover:bg-white/20"
                            >
                                {isUploadingResource ? "Upload..." : "Uploader"}
                            </button>
                        </div>
                    </section>
                </div>
