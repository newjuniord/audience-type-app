...
exports.onchatmessagecreated = exports.sendAlertPushNotification = exports.webhookbotmessage = exports.onenrollmentcreated = exports.lemonsqueezyrefund = exports.lemonsqueezywebhookbackup = void 0;
 ...
 */
exports.lemonsqueezywebhookbackup = (0, https_1.onRequest)({
    secrets: [
    ...
    try {
        ...
        if (orderData?.productType !== "service" && orderData?.productType !== "booking") {
            ...
            try {
                ...
                if (!bookingSnap.empty) {
                    ...
                    bookingSnap.docs.forEach((doc) => {
                        ...
                        if (!bookingDate && bData.date)
                            bookingDate = bData.date;
                        if (!bookingTime && bData.time)
            ...
            if (userId) {
                await generateAndSendNotification(userId, orderData?.userName || "", orderData?.productTitle || "Consultation", orderData?.productType || "service", false);
            }
        }
 ...
 */
exports.onchatmessagecreated = (0, firestore_1.onDocumentCreated)({ document: "chats/{userId}/messages/{messageId}", region: "us-central1" }, async (event) => {
    const snapshot = event.data;
    if (!snapshot)
        return;
