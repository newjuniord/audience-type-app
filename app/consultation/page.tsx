    ...
    return (
      <div className="min-h-screen bg-background-dark text-white font-display flex flex-col justify-between">
        ...
        <main className="flex-1 flex flex-col items-center justify-center text-center px-5 py-24">
          ...
          <p className="text-white/50 max-w-md mx-auto mb-6">Rezèvasyon yo fèmen pou kounye a. Tanpri tounen pita oswa kontakte nou sou WhatsApp si w ta renmen mande yon plas espesyal.</p>
          <a 
            href="https://wa.me/18296692914?text=Bonjou,%20mwen%20ta%20renmen%20rez%C3%A8ve%20yon%20konsiltasyon."
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-6 py-3.5 bg-[#25D366] hover:bg-[#1ebd5a] text-white rounded-xl font-black uppercase tracking-wide text-xs active:scale-95 transition-all shadow-lg shadow-[#25D366]/20"
          >
            ...
            <span>Kontakte nou sou WhatsApp</span>
          </a>
        </main>
