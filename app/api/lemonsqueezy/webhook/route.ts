            ...
            try {
                ...
                if (productType === "course" || productType === "ebook") {
                    ...
                    if (!existingEnrollment.empty) {
                        ...
                        console.log(`🔒 [WEBHOOK] Access revoked for user ${userId} on product ${productId}`);
                    }
                }
                ...
                if (productType === "service" || productType === "booking") {
                    ...
                    if (!bookingSnap.empty) {
                        ...
                        await batch.commit();
                        console.log(`🚫 [WEBHOOK] Consultation cancelled for user ${userId} on service ${productId}`);
                    }
                }
            } catch (e) {
                console.error("❌ [WEBHOOK] Error handling refund logic:", e);
            }
        }
