                        ...
                        <div className="space-y-16 text-white/70 leading-relaxed text-base">
                            ...
                            <section id="user-accounts">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <p className="pt-2 font-medium">En cas d'utilisation suspecte ou non autorisée de votre compte, veuillez nous contacter immédiatement à l'adresse : contact@djrakademi.net.</p>
                                </div>
                            </section>
                            ...
                            <section id="termination">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <ul className="list-disc pl-5 space-y-4">
                                        <li>
                                            <strong>Résiliation par l’Utilisateur :</strong> Vous pouvez cesser d’utiliser nos Consultations à tout moment. Si vous souhaitez supprimer votre compte, vous pouvez le faire via les paramètres de votre espace client ou en envoyant une demande à contact@djrakademi.net.
                                        </li>
                                        <li>
