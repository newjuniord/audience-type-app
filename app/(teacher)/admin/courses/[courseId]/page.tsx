        ...
        <main className="max-w-6xl mx-auto animate-in fade-in duration-700 pb-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div className="lg:col-span-2 space-y-8">
                    {/* Video Player Area */}
                    <div className="w-full shadow-2xl shadow-black/20 rounded-3xl">
                        {activeLesson ? (
                            <VideoPlayer url={activeLesson.videoUrl} />
                        ) : (
                            <div className="aspect-video bg-black rounded-3xl overflow-hidden relative flex items-center justify-center">
