            ...
            <main className="max-w-4xl mx-auto px-6 py-8">
                ...
                <footer className="mt-24 pt-12 border-t border-zinc-200 dark:border-zinc-800 flex flex-col md:flex-row items-center justify-between gap-6 pb-12">
                    <div className="flex items-center gap-2">
                        ...
                        <p className="text-xs font-bold uppercase tracking-widest text-zinc-400">Audience Type Academy</p>
                    </div>
                    ...
                    <p className="text-[10px] text-zinc-400 font-medium">© 2026 Audience Type.</p>
                </footer>
            </main>
        </div>
    );
